# Consuming Nextera Design System in web apps

Read `artifacts/nextera-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/nextera-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/nextera-design-system/styles.css";
```
...
`node_modules/@workspace/nextera-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/nextera-design-system/components/ui/button";
import { cn } from "@workspace/nextera-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/nextera-design-system/hooks/use-toast";
```
...
`@workspace/nextera-design-system/components/ui/button`. Run the app's typecheck
