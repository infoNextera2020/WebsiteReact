# Consuming Nextera Design System in Expo apps

Read `artifacts/nextera-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/nextera-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/nextera-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/nextera-design-system/lib/native-theme";
import { useColors } from "@workspace/nextera-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/nextera-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/nextera-design-system/components/native/badge";
import { Button } from "@workspace/nextera-design-system/components/native/button";
import { Card } from "@workspace/nextera-design-system/components/native/card";
```
...
Import and render
`@workspace/nextera-design-system/components/native/button`, then run Expo
