...
function App() {
  ...
  const onSubmit = async (data: ApplicationForm) => {
      const scriptUrl = 'https://script.google.com/macros/s/AKfycbxwfCFqiIGSy6yWT1GLDfKRlk5M5Q68LPr9Mz8SiOrhEpBvvx3bRCvdi9-1hIqx-xvf/exec';
            ...
            >
              ...
              >
                ...
                <h2 style={{ fontSize: '32px', fontFamily: 'var(--app-font-serif)', margin: '0 0 16px', color: 'hsl(var(--foreground))' }}>
                  NextEra <span style={{ fontWeight: 300, color: 'hsl(var(--muted-foreground))' }}>×</span> BM YOUTH
                </h2>
        ...
        <nav className={`nav ${scrolled ? 'scrolled' : ''}`}>
          <div style={{ background: 'hsl(var(--primary))', color: 'hsl(var(--primary-foreground))', textAlign: 'center', padding: '10px 20px', fontSize: '14px', fontWeight: 600, letterSpacing: '0.05em' }}>
            <a href="#partnership" style={{ display: 'block', textUnderlineOffset: '4px' }}>
              {lang === 'ar' ? 'عرض حصري: فترة تجريبية مجانية لمدة أسبوع لعملاء BM YOUTH!' : 'Exclusive Offer: One Week Free Trial for BM YOUTH Customers!'}
            </a>
          </div>
