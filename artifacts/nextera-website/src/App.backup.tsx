  ...
  return (
    <SiteFrame loader>
      <main>
        ...
        <section
          id="communities"
          className="section light-band"
          aria-labelledby="community-title"
        >
          <div className="container">
            <p className="eyebrow">Built with communities</p>
            <h2 id="community-title" className="display section-heading">
              Programs for communities
            </h2>
            <p className="section-intro">
              We partner with universities and communities to design and deliver
              impactful programs that prepare students for the future of work.
            </p>
            <div className="community-grid" style={{ marginTop: 45 }}>
              <article className="surface-card community-card">
                <h3 className="card-title">01 Coding Academies</h3>
                <p className="card-body">
                  Immersive, project-based coding programs built around peer
                  learning, real challenges, and career readiness.
                </p>
              </article>
              <article className="surface-card community-card">
                <h3 className="card-title">IoT Programs</h3>
                <p className="card-body">
                  Hands on workshops and innovation challenges using sensors,
                  microcontrollers and connected devices.
                </p>
              </article>
              <article className="surface-card community-card">
                <h3 className="card-title">Customized Programs</h3>
                <p className="card-body">
                  Tailored technology programs designed around your learners,
                  objectives, schedule and delivery needs.
                </p>
              </article>
            </div>
            <div className="center-action">
              <a
                href="/about"
                className="button"
                data-testid="link-discuss-partnership"
              >
                Discuss a partnership <ExternalLink size={15} />
              </a>
            </div>
          </div>
        </section>
  ...
  return (
    <SiteFrame>
      <main>
        ...
        >
          <div className="container">
            ...
            <h2 id="specializations-title" className="display section-heading">
              Choose your tech branch
            </h2>
            <p className="section-intro">
              After mastering your 18-month foundation, you unlock advanced
              specialization branches to define your career.
            </p>
            <div className="card-grid" style={{ marginTop: 45 }}>
              <article className="legacy-list-card">
                <h3 className="card-title">Data Science &amp; BI</h3>
                <p className="card-body">
                  Master Python, machine learning libraries like Scikit-learn
                  and TensorFlow, and enterprise visualization tools including
              ...
              <article className="legacy-list-card">
                ...
                <p className="card-body">
                  Build highly scalable, responsive web and mobile applications
                  using modern JavaScript frameworks, robust backends, and cloud
                  infrastructure.
                </p>
              </article>
              <article className="legacy-list-card">
                <h3 className="card-title">Cybersecurity &amp; Systems</h3>
                <p className="card-body">
                  Dive deep into network defense, ethical hacking, cryptography,
                  and securing operating systems against modern vulnerabilities.
                </p>
              </article>
            </div>
            ...
            <p className="section-intro">
              Our pioneers are currently writing their first lines of code. By
              the end of your journey, here is a preview of the capstone
              architecture you will be building.
            </p>
            <div className="card-grid two" style={{ marginTop: 45 }}>
              <article className="legacy-list-card">
                <div className="architecture-block">[ AI &amp; Logic ]</div>
                <h3 className="card-title">Machine Learning Systems</h3>
                <p className="card-body">
                  Design and implement complex backend software, such as a full
                  Pharmacy Inventory Management System enhanced with Machine
                  Learning to predict stock depletion and automate logistics.
                </p>
              </article>
              <article className="legacy-list-card">
                ...
                <h3 className="card-title">Business Intelligence Pipelines</h3>
                <p className="card-body">
                  Engineer robust data warehousing solutions, utilizing advanced
                  SQL to process raw datasets and converting them into
            ...
            <div className="card-grid two" style={{ marginTop: 64 }}>
              {[
                [
                  "1",
                  "The Game",
                  "A 90-minute online cognitive assessment testing your memory and logic. No coding required.",
                ],
                [
                  "2",
                  "The Check-In",
                  "An intro event to meet the team, explore the campus, and understand the commitment.",
                ],
                [
                  "3",
                  "The Piscine",
                  "A grueling, intensive 4-week coding bootcamp to test your resilience, logic, and peer collaboration.",
                ],
                [
                  "4",
                  "The Core Program",
                  "Pass the Piscine, and you earn your seat in the ultimate 2-year software engineering journey.",
                ],
        ...
        <Section
          id="game"
          eyebrow="Step 1: Pre-Piscine game"
          title="Your problem-solving DNA"
            ...
            <div className="primitive-card">
              ...
              <ul
                ...
                style={{
                  ...
                  color: "hsl(var(--ink-foreground) / .76)",
                }}
              >
              ...
              >
                <li>
                  Adaptability — how quickly you change a failing strategy
                </li>
                <li>Learning speed — how fast new rules become instinct</li>
                <li>Grit — what you do at the hard level, not the easy one</li>
                <li>
                  Collaborative instinct — whether you seek input or dig in
                  alone
                </li>
              </ul>
            </div>
            <div className="primitive-card">
              ...
              <div className="quadrant-grid">
                <div className="quadrant">
                  <h4>Methodical Grinder</h4>
                  <p>Keeps going, needs sharper strategy.</p>
                </div>
                <div className="quadrant">
                  <h4>Natural Engineer</h4>
                  <p>Solves hard problems and refuses to stop.</p>
                </div>
                <div className="quadrant">
                  <h4>Explorer</h4>
                  <p>Curious start, fades under resistance.</p>
                </div>
                <div className="quadrant">
                  <h4>Quick Sprinter</h4>
                  <p>Fast insight, tested by long problems.</p>
                </div>
              </div>
              <p
                style={{
                  marginTop: 24,
                  color: "hsl(var(--ink-foreground) / .68)",
                }}
              >
                No quadrant is a rejection. The game shows where you stand today
                and which muscle the Piscine will build first.
              </p>
            </div>
          </div>
        </Section>
        ...
        >
          ...
          <h3
            className="card-title"
            style={{ marginTop: 55, fontSize: "1rem" }}
          >
            A day in the Piscine
          </h3>
          <ol className="day-grid">
            {dayInLife.map((day) => (
              <li className="day-card" key={day.time}>
        ...
        <section className="legacy-section band">
          <div className="container">
            ...
            <p className="section-intro">
              Tech isn't just for math geniuses. We are looking for diverse
              minds, unique backgrounds, and relentless problem solvers.
            </p>
            <div className="card-grid two" style={{ marginTop: 45 }}>
              {[
                [
                  "The Gamer",
                  "You love grinding for achievements, optimizing stats, and solving complex logic puzzles.",
                ],
                [
                  "The Artist",
                  "You have an eye for design and want to bring beautiful, intuitive user interfaces to life.",
                ],
                [
                  "The Career Switcher",
                  "You are ready for a change, bringing maturity, focus, and real-world skills to the tech industry.",
                ],
                [
                  "The High School Grad",
                  "You want to bypass the traditional 4-year degree and dive straight into high-end software engineering.",
                ],
              ].map(([title, body]) => (
                <article className="legacy-list-card" key={title}>
                  <h3 className="card-title">{title}</h3>
        ...
        <section className="legacy-section">
          <div className="container" style={{ textAlign: "center" }}>
            ...
            <div className="academy-map" aria-label="Curriculum map">
              ...
              <span className="map-node active">FOUNDATION</span>
