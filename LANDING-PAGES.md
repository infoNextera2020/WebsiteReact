...
| Address | Source |
| --- | --- |
| `/academy-landing` | `shahdelganzoury/NextEra-Academy-Landing-Page-1`, commit `a6665f3809c49b62b6439ff5516353c4b0b9a02e` |
...
The output directory remains `artifacts/nextera-website/dist`. It contains the main `index.html`, `academy-landing/index.html`, `vip/index.html`, shared build assets, and isolated public images for each landing page.
