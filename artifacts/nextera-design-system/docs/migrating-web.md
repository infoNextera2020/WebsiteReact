# Migrating web UI to Nextera Design System

Read `artifacts/nextera-design-system/docs/AGENTS.md` and
`artifacts/nextera-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/nextera-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/nextera-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/nextera-design-system/hooks/use-toast`
